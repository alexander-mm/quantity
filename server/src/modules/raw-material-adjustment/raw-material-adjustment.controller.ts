...
import { RawMaterialAdjustmentService } from "./raw-material-adjustment.service.js";

export class RawMaterialAdjustmentController {

    private readonly service = new RawMaterialAdjustmentService();
