  ...
  return (
    <div className="relative">
      ...
      <ComboboxPrimitive.Clear
        ...
        className="absolute top-1/2 right-1.5 -translate-y-1/2 rounded-sm p-0.5 text-muted-foreground outline-none hover:text-foreground focus-visible:ring-2 focus-visible:ring-ring/50"
...
function ComboboxEmpty({
  ...
  return (
    <ComboboxPrimitive.Empty
      ...
      className={cn(
        "p-3 text-center text-sm text-muted-foreground empty:m-0 empty:p-0",
        className
      )}
      {...props}
    />
